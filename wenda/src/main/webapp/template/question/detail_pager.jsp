...
<head>
    ...
    <script>
	    ...
	    window.deviceJump&& deviceJump.init({
	        "main": "${ROOT}/${question.id}-${pager.pageNo}.html",//这里需要自己手动写入pc版连接,如没有可为空
	        "ipad": "",//这里需要自己手动写入ipad版连接,如没有可为空
	        "wap": "${WAPROOT}/${question.id}-${pager.pageNo}.html",//这里需要自己手动写入简版连接,如没有可为空
	        "wap_3g": "${WAPROOT}/${question.id}-${pager.pageNo}.html"//这里需要自己手动写入炫版连接,如没有可为空
	    });
    </script>
    <!-- 设备跳转模块 E -->
	<link href="//js.3conline.com/pcautonew1/pc/2019/wenda/css/answerList.css" rel="stylesheet">
</head>
...
<body id="Jimg_load">
    ...
    <div class="section mt40">
        <div class="layAB">
            ...
            <div id="Janswerbox-tag" class="mt50"></div>
        </div>
        <div class="layC">
        	<div id="JscrollFixed">
	            <!-- 热门回答 -->
	...
	<script type="text/javascript" src="//js.3conline.com/pcautonew1/pc/2019/wenda/js/answerList.bundle.js"></script>
</body>
</html>